...
Feature: Digital Bank Registration Page
  ...
  Background:
    Given The user with "jack1@test.co" is not in DB
  ...
  Scenario: Positive Case. As a user, I want to successfully create Digital Bank account
    When User creates account with following fields
      ...
      | Mr.   | Jack      | Test     | M      | 12/12/1990 | 127-24-4687 | jack1@test.co | Tester123 | 12 Main st | City     | CA     | 99921      | US      | 2146591008 | 2136591208  | 1126593008 | true           |
    ...
    Then the following user info should be saved in the db
      ...
      | Mr.   | Jack      | Test     | M      | 12/12/1990 | 127-24-4687 | jack1@test.co | Tester123 | 12 Main st | City     | CA     | 99921      | US      | 2146591008 | 2136591208  | 1126593008 |true             |true            |true                 |true   |
