...
public class RegistrationSteps {
    ...
    public void theFollowingUserInfoShouldBeSavedInTheDb(List<Map<String, String>> expectedUserProfileInfoDBList) {
    ...
    public void theUserWithIsNotInDB(String email) {
        ...
        String queryRoGetNextValueInHibernateSequenceTable = String.format("SELECT * FROM hibernate_sequence");
        nextValueList = DBUtils.runSQLSelectQuery(queryRoGetNextValueInHibernateSequenceTable);
